...
final class AssetsManager
{
    ...
    function _loadAdminAssets($hook_suffix)
    {
        if ('cafe-plugin-settings' === $hook_suffix) {
            ...
            wp_enqueue_script('cafe-admin', CAFE_URI . 'assets/js/admin.min.js', [], Plugin::VERSION, true);
        }
    }
    ...
    function _afterRegisterFrontendStyles()
    {
        ...
        wp_register_style('slick', CAFE_URI . 'assets/vendor/slick/slick.css', [], '1.9.0');
    }
    ...
    {
        wp_register_script('vimeoapi', 'https://player.vimeo.com/api/player.js', ['jquery-core'], Plugin::VERSION, true);
        wp_register_script('youtube-api', 'https://www.youtube.com/player_api', ['jquery-core'], Plugin::VERSION, true);
        ...
        wp_register_script('infinite', CAFE_URI . 'assets/vendor/infinite-scroll/infinite-scroll.pkgd.min.js', ['jquery-core'], '3.0.5', true);
        ...
        wp_register_script('mousewheel', CAFE_URI . 'assets/vendor/mousewheel/jquery.mousewheel.min.js', ['jquery-core'], Plugin::VERSION, true);
        wp_register_script('isotope', CAFE_URI . 'assets/vendor/isotope/isotope.pkgd.min.js', ['jquery-core'], Plugin::VERSION, true);
        wp_register_script('slick', CAFE_URI . 'assets/vendor/slick/slick.min.js', ['jquery-core'], '1.9.0', true);
    ...
    function _add_ajax_url()
    {
        ...
        wp_add_inline_script('cafe-script', $ajaxurl);
    }
