...
final class SettingsPage
{
        ...
        <div class="cafe-plugin-settings">
            <div class="nav-bar">
                <div class="branding">
                    ...
                    <p class="plugin-version"><?php esc_html_e('Version', 'cafe-lite') ?>
                ...
                <ul>
                    ...
                    <li><a class="nav-item active-item"
                            href="#elements-settings"><?php esc_html_e('Elements', 'cafe-lite') ?></a></li>
                </ul>
            </div>
                ...
                <form class="form-table" action="options.php" method="post">
                    ...
                    <table id="elements-settings" class="tab-table">
                        ...
                        <tr>
                            <td>
                                <p class="description">
                                    <?php esc_html_e('Disable unused elements may improve your site performance.', 'cafe-lite') ?>
                                </p>
                            </td>
                            <?php
                            foreach ($widgets as $widget):
                                if ($widget->isFile()) {
                                    ...
                                    if (false !== strpos($filename, '.php') && 'class-clever-widget-base.php' !== $filename):
                                        ...
                                        <td>
                                            <label>
                                                <input type="checkbox" name="<?php echo esc_attr($this->getName($filename)) ?>" value="1"
                                                    <?php if ($disabled)
                                                        echo ' checked'; ?>>
                                                <span><?php echo esc_html($element) ?></span>
                                            </label>
                                        </td>
                                        <?php
                                    endif;
    ...
    public function _notify()
    {
        ...
        if (isset($_REQUEST['settings-updated']) && 'true' === sanitize_text_field($_REQUEST['settings-updated'])) {
        ...
        if ( check_admin_referer() ) exit;
        if (isset($_REQUEST['error']) && 'true' === sanitize_text_field($_REQUEST['error'])) {
