    ...
    final class CleverPortfolios extends CleverWidgetBase
    {
        ...
        protected function register_controls()
        {
            ...
            $this->add_control('content_background_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .clever-portfolio:not(.style-3) .clever-portfolio-item' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .style-3 .clever-portfolio-item .portfolio-info' => 'background-color: {{VALUE}};'
                ]
            ]);
        ...
        {
            return ['cafe-style', 'clever-portfolio', 'slick'];
        }
        ...
        {
            return ['slick', 'cafe-script', 'isotope', 'clever-portfolio-js'];
        }
