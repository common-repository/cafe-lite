...
final class CleverServices extends CleverWidgetBase
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('col', [
            'label' => esc_html__('Columns Show', 'cafe-lite'),
        ...
        $this->add_control('col_tablet', [
            'label' => esc_html__('Columns Show (Tablet)', 'cafe-lite'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('col_mobile', [
            'label' => esc_html__('Columns Show (Mobile)', 'cafe-lite'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('row', [
            'label' => esc_html__('Row', 'cafe-lite'),
