...
final class CleverTestimonial extends CleverWidgetBase
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control('star', [
            'label' => esc_html__('Star', 'cafe-lite'),
        ...
        $this->add_control('slides_to_show', [
            'label' => esc_html__('Slide To Show', 'cafe-lite'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('slides_to_show_tablet', [
            'label' => esc_html__('Slide To Show (Tablet)', 'cafe-lite'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('slides_to_show_mobile', [
            'label' => esc_html__('Slide To Show (Mobile)', 'cafe-lite'),
            'type' => Controls_Manager::SLIDER,
            'range' => [
                'px' => [
                    'min' => 1,
        ...
        $this->add_control('slider_nav_pos', [
            'label' => esc_html__('Position', 'cafe-lite'),
            'type' => Controls_Manager::SELECT,
            'default' => 'middle',
            'options' => [
                'middle' => esc_html__('Middle', 'cafe-lite'),
        ...
        $this->add_responsive_control('content_border_radius', [
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .cafe-testimonial-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        $this->end_controls_section();
        ...
        $this->add_control('slider_nav_bg', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .cafe-carousel .cafe-carousel-btn' => 'background: {{VALUE}};'
            ]
        ]);
        $this->end_controls_tab();

        $this->start_controls_tab('hover', ['label' => esc_html__('Hover and Active', 'cafe-lite')]);
        ...
        $this->add_control('slider_nav_hover_bg', [
            'label' => esc_html__('Background Color', 'cafe-lite'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .cafe-carousel .cafe-carousel-btn:hover' => 'background: {{VALUE}};'
            ]
        ]);
        $this->end_controls_tab();
        ...
        $this->add_responsive_control('slider_nav_border_radius', [
            'label' => esc_html__('Border radius', 'cafe-lite'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em'],
            'separator' => 'before',
        ...
        $this->end_controls_section();
        $this->start_controls_section('slider_pag_settings', [
        ...
        $this->add_control('slider_pag_hover_color_heading', [
            'label' => esc_html__('Hover and Active', 'cafe-lite'),
            'type' => Controls_Manager::HEADING,
            'separator' => 'after',
        ]);
