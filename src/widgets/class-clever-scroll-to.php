...
final class CleverScrollTo extends CleverWidgetBase
{
    ...
    protected function render()
    {
        ...
        echo $this->get_render_attribute_string('vertical_scroll_wrapper'); ?>
            data-settings='<?php echo wp_json_encode($scroll_settings); ?>'>
            <div <?php
            // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped 
            echo $this->get_render_attribute_string('vertical_scroll_inner'); ?>>
                <div <?php
                // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped
                echo $this->get_render_attribute_string('vertical_scroll_dots'); ?>>
                    <ul <?php
                    // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped
                    echo $this->get_render_attribute_string('vertical_scroll_dots_list'); ?>>
                        <?php foreach ($templates as $index => $section): ?>
                            <li data-index="<?php echo esc_attr($index); ?>"
                                data-menuanchor="<?php echo esc_attr($checkType ? 'section_' . $id . $index : $templates[$index]['section_id']); ?>"
                                class="cafe-scrollto-nav-item" data-label="<?php echo esc_attr($section['label']) ?>">
                                <div class="cafe-scrollto-nav-item-link"><i class="<?php echo esc_attr($section['icon']) ?>"></i>
                                    <?php if ($settings['dots_tooltips_switcher'] == 'yes') { ?><span
                                            class="label"><?php echo esc_html($section['label']) ?></span><?php } ?>
                                </div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                ...
                <?php if ('templates' === $settings['content_type']): ?>
                    <div <?php
                    // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped
                    echo $this->get_render_attribute_string('vertical_scroll_sections_wrap'); ?>>
                        ...
                        <?php foreach ($templates as $index => $section):
                            ...
                            <div <?php
                            // phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped
                            echo $this->get_render_attribute_string('section_' . $index); ?>>
                                <?php
