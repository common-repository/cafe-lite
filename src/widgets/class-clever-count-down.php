...
final class CleverCountDown extends CleverWidgetBase
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('day_label', [
            'label' => esc_html__('Days label', 'cafe-lite'),
            'type' => Controls_Manager::TEXT,
            'default' => 'Days',
        ]);
        $this->add_control('hour_label', [
            'label' => esc_html__('Hours label', 'cafe-lite'),
            'type' => Controls_Manager::TEXT,
            'default' => 'Hours',
        ]);
        $this->add_control('min_label', [
            'label' => esc_html__('Minutes label', 'cafe-lite'),
            'type' => Controls_Manager::TEXT,
            'default' => 'Mins',
        ]);
        $this->add_control('sec_label', [
            'label' => esc_html__('Seconds label', 'cafe-lite'),
            'type' => Controls_Manager::TEXT,
            'default' => 'Secs',
        ]);
