...
final class CleverButton extends CleverWidgetBase
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control('button_border_width', [
            ...
            'size_units' => ['px'],
            'selectors' => [
                '{{WRAPPER}} .cafe-button:before,{{WRAPPER}} .cafe-button:after,{{WRAPPER}} .cafe-button.line-through,{{WRAPPER}} .cafe-button.flat' => 'border-width: {{SIZE}}{{UNIT}};',
            ],
        ]);
	    $this->add_control('button_border', [
		    ...
		    'type' => Controls_Manager::COLOR,
		    'selectors' => [
			    '{{WRAPPER}} .cafe-button:before,{{WRAPPER}} .cafe-button:after, {{WRAPPER}} .cafe-button.line-through,{{WRAPPER}} .cafe-button.flat' => 'border-color: {{VALUE}};'
		    ]
	    ]);
