...
final class CleverSlider extends CleverWidgetBase
{
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control('heading_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} {{CURRENT_ITEM}} .cafe-slide-heading.first-heading' => 'color: {{VALUE}}',
            ],
            'conditions' => [
                'terms' => [
                    [
        ...
        $this->add_control('show_arrows', [
            'label' => esc_html__('Show Arrows (Desktop)', 'cafe-lite'),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes'
        ]);
        $this->add_control('show_arrows_tablet', [
            'label' => esc_html__('Show Arrows (Tablet)', 'cafe-lite'),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes'
        ]);
        $this->add_control('show_arrows_mobile', [
            'label' => esc_html__('Show Arrows (Mobile)', 'cafe-lite'),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'no'
        ]);
        $this->add_control('show_dots', [
            'label' => esc_html__('Show Dots (Desktop)', 'cafe-lite'),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
            'tablet_default' => 'yes',
            'mobile_default' => 'no'
        ]);
        $this->add_control('show_dots_tablet', [
            'label' => esc_html__('Show Dots (Tablet)', 'cafe-lite'),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
            'tablet_default' => 'yes',
            'mobile_default' => 'no'
        ]);
        $this->add_control('show_dots_mobile', [
            'label' => esc_html__('Show Dots (Mobile)', 'cafe-lite'),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
            'tablet_default' => 'yes',
            'mobile_default' => 'no'
        ...
        $this->add_responsive_control('heading_spacing', [
            ...
            'selectors' => [
                '{{WRAPPER}} .slick-slide-inner .cafe-slide-heading.first-heading' => 'margin-bottom: {{SIZE}}{{UNIT}}',
            ],
        ]);
        ...
        $this->add_control('heading_color', [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .cafe-slide-heading.first-heading' => 'color: {{VALUE}}',
        ...
        $this->add_group_control(Group_Control_Typography::get_type(), [
            ...
            'selector' => '{{WRAPPER}} .cafe-slide-heading.first-heading',
        ]);
